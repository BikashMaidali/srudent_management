      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="{{url('view_student')}}" aria-expanded="false" aria-controls="ui-basic">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach($student as $data)
                            ...
                            <td><a onclick="return confirm('Are You Sure?')" href="{{url('delete_std',$data->id)}}" class="btn btn-danger">Remove</a></td>
                            </tr>
                        @endforeach
                      </tbody>
                    </table>
